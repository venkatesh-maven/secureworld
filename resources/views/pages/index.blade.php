        ...
        <div class="content-header justify-content-center justify-content-lg-between">
          ...
          <div class="d-flex align-items-center">
            ...
            <a class="link-fx fs-lg fw-semibold text-dark" href="">
              ...
              <small class="fw-medium">5.8</small>
            </a>
            <!-- END Logo -->
          </div>
          <!-- END Left Section -->
      ...
      <main id="main-container">
        ...
        <div class="bg-body-extra-light">
          <div class="content content-top text-center">
            ...
            <div class="row g-0 justify-content-center mb-6">
              <div class="col-lg-8">
                ...
                <div>
                  ...
                  <a class="btn btn-alt-primary px-4 py-2 m-1" href="be_pages_dashboard.html" target="_blank">
            ...
            <div style="margin-bottom: -170px;">
              <img class="img-fluid" src="assets/media/various/promo_hero_v5.png" srcset="assets/media/various/promo_hero_v5@2x.png 2x" alt="Dashmix Promo Hero Image v5">
            </div>
          </div>
        </div>
        <!-- END Hero -->
            ...
            <div class="row items-push-2x">
              ...
              <div class="col-md-6">
                ...
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    <h4 class="mb-1">Laravel 10 Starter Kit</h4>
                    <p class="text-muted mb-0">
          ...
          <div class="content content-full">
            ...
            <div class="row items-push">
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_file_hosting.html">
                  <div class="block-content bg-gd-xdream">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_file_hosting.png" srcset="assets/media/various/promo_dashboard_file_hosting@2x.png 2x" alt="File Hosting Dashboard">
                    </div>
                  </div>
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_wp_post.html">
                  <div class="block-content bg-gd-xwork">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_wp_post.png" srcset="assets/media/various/promo_dashboard_wp_post@2x.png 2x" alt="WP Post Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_corporate_slim.html">
                  <div class="block-content bg-gd-xpro">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_corporate_slim.png" srcset="assets/media/various/promo_dashboard_corporate_slim@2x.png 2x" alt="Corporate Slim Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_analytics.html">
                  <div class="block-content bg-xpro-dark">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_analytics.png" srcset="assets/media/various/promo_dashboard_analytics@2x.png 2x" alt="Analytics Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_chat.html">
                  <div class="block-content bg-xdream-light">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_chat.png" srcset="assets/media/various/promo_dashboard_chat@2x.png 2x" alt="Chat Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_social_compact.html">
                  <div class="block-content bg-xmodern-light">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_social_compact.png" srcset="assets/media/various/promo_dashboard_social_compact@2x.png 2x" alt="Social Compact Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_travel.html">
                  <div class="block-content bg-gd-sea">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_travel.png" srcset="assets/media/various/promo_dashboard_travel@2x.png 2x" alt="Travel Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_medical.html">
                  <div class="block-content bg-gd-sublime">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_medical.png" srcset="assets/media/various/promo_dashboard_medical@2x.png 2x" alt="Medical Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_tasks.html">
                  <div class="block-content bg-gd-aqua">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_tasks.png" srcset="assets/media/various/promo_dashboard_tasks@2x.png 2x" alt="Tasks Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_hosting.html">
                  <div class="block-content bg-xmodern">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_hosting.png" srcset="assets/media/various/promo_dashboard_hosting@2x.png 2x" alt="Hosting Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_booking.html">
                  <div class="block-content bg-xinspire-darker">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_booking.png" srcset="assets/media/various/promo_dashboard_booking@2x.png 2x" alt="Booking Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_gaming.html">
                  <div class="block-content bg-xeco-darker">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_gaming.png" srcset="assets/media/various/promo_dashboard_gaming@2x.png 2x" alt="Gaming Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_classic_boxed.html">
                  <div class="block-content bg-default-lighter">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_classic_boxed.png" srcset="assets/media/various/promo_dashboard_classic_boxed@2x.png 2x" alt="Classic Boxed Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_crypto.html">
                  <div class="block-content bg-dark">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_crypto.png" srcset="assets/media/various/promo_dashboard_crypto@2x.png 2x" alt="Crypto Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_banking.html">
                  <div class="block-content bg-xwork-light">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_banking.png" srcset="assets/media/various/promo_dashboard_banking@2x.png 2x" alt="Banking Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_social.html">
                  <div class="block-content bg-xmodern-dark">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_social.png" srcset="assets/media/various/promo_dashboard_social@2x.png 2x" alt="Social Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_dark.html">
                  <div class="block-content bg-dark">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_dark.png" srcset="assets/media/various/promo_dashboard_dark@2x.png 2x" alt="Dark Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_modern.html">
                  <div class="block-content bg-gd-dusk">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_modern.png" srcset="assets/media/various/promo_dashboard_modern@2x.png 2x" alt="Modern Dashboard">                            </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
                      Modern
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_minimal.html">
                  <div class="block-content bg-xwork-lighter">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_minimal.png" srcset="assets/media/various/promo_dashboard_minimal@2x.png 2x" alt="Minimal Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="db_messages.html">
                  <div class="block-content bg-xsmooth">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard_messages.png" srcset="assets/media/various/promo_dashboard_messages@2x.png 2x" alt="Messages Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
              ...
              <div class="col-sm-6 col-xl-4">
                <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_dashboard.html">
                  <div class="block-content bg-default">
                    <div class="pt-2 px-2 pull-b">
                      <img class="img-fluid" src="assets/media/various/promo_dashboard.png" srcset="assets/media/various/promo_dashboard@2x.png 2x" alt="Default Dashboard">
                    </div>
                  </div>
                  <div class="block-content block-content-full">
                    <h4 class="h6 mb-1">
                ...
                <div class="block-content block-content-full">
                  <div class="row justify-content-sm-between align-items-center p-md-3">
                    ...
                    <div class="col-sm-6 text-sm-end">
                      <a class="btn btn-primary px-4 py-2" href="be_pages_dashboard.html">
                        Explore it!
        ...
        <div id="dm-widgets" class="bg-body-light">
          <div class="content">
            ...
            <div class="row py-3">
              <div class="col-md-6 d-md-flex align-items-md-center">
                <div class="w-100">
                  <div class="row g-sm">
                    <div class="col-sm-6">
                      <a class="block text-center bg-image" style="background-image: url('assets/media/photos/photo19.jpg');" href="javascript:void(0)">
            ...
            <div class="row py-3">
              <div class="col-md-6 d-md-flex align-items-md-center">
                <a class="block block-rounded block-link-pop w-100 my-3 bg-image text-center" style="background-image: url('assets/media/photos/photo18.jpg');" href="javascript:void(0)">
                  <div class="block-content block-content-full bg-white-90">
                    ...
                    <p class="fs-lg fw-semibold text-black mb-0 mt-2">Jose Mills</p>
              ...
              <div class="block block-rounded block-transparent bg-body">
                <div class="block-content block-content-full">
                  <div class="row justify-content-sm-between align-items-center p-md-3">
                    ...
                    <div class="col-sm-6 text-sm-end">
                      <a class="btn btn-primary px-4 py-2" href="be_widgets_tiles.html">
                        Explore them all
                        <i class="fa fa-fw fa-arrow-right opacity-50 ms-1"></i>
                      </a>
                    </div>
          ...
          <div class="content content-full">
            ...
            <div class="row items-push-2x">
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_page_default.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_default.png" srcset="assets/media/various/promo_layout_default@2x.png 2x" alt="Default Layout">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Default Layout
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_page_flipped.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_flipped.png" srcset="assets/media/various/promo_layout_flipped@2x.png 2x" alt="Flipped Layout">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Flipped Layout
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_sidebar_hidden.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_sidebar_hidden.png" srcset="assets/media/various/promo_layout_sidebar_hidden@2x.png 2x" alt="Hidden Sidebar">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Hidden Sidebar
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_content_side_left.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_content_side_left.png" srcset="assets/media/various/promo_layout_content_side_left@2x.png 2x" alt="Left Side Content">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Left Side Content
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_content_side_right.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_content_side_right.png" srcset="assets/media/various/promo_layout_content_side_right@2x.png 2x" alt="Right Side Content">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Right Side Content
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_page_native_scrolling.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_native_scrolling.png" srcset="assets/media/various/promo_layout_native_scrolling@2x.png 2x" alt="Native Scrolling">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Native Scrolling
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_sidebar_dark.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_sidebar_dark.png" srcset="assets/media/various/promo_layout_sidebar_dark@2x.png 2x" alt="Dark Sidebar">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Dark Sidebar
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_header_static_dark.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_header_static.png" srcset="assets/media/various/promo_layout_header_static@2x.png 2x" alt="Static Header">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Static Header
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_side_overlay_visible.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_side_overlay_visible.png" srcset="assets/media/various/promo_layout_side_overlay_visible@2x.png 2x" alt="Visible Side Overlay">
                  </a>
                </div>
                <h4 class="h5 mb-2">
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_content_main_full_width.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_content_main_full_width.png" srcset="assets/media/various/promo_layout_content_main_full_width@2x.png 2x" alt="Main Content Full Width">
                  </a>
                </div>
                <h4 class="h5 mb-2">
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_content_main_narrow.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_content_main_narrow.png" srcset="assets/media/various/promo_layout_content_main_narrow@2x.png 2x" alt="Main Content Narrow">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Main Content Narrow
              ...
              <div class="col-sm-6 col-md-4 mb-5 text-center">
                <div class="mb-3">
                  <a class="img-link" href="be_layout_content_main_boxed.html">
                    <img class="img-fluid" src="assets/media/various/promo_layout_content_main_boxed.png" srcset="assets/media/various/promo_layout_content_main_boxed@2x.png 2x" alt="Main Content Boxed">
                  </a>
                </div>
                <h4 class="h5 mb-2">
                  Main Content Boxed
              ...
              <div class="block block-rounded block-transparent bg-body">
                <div class="block-content block-content-full">
                  <div class="row justify-content-sm-between align-items-center p-md-3">
                    ...
                    <div class="col-sm-6 text-sm-end">
                      <a class="btn btn-alt-primary px-4 py-2" href="be_layout_api.html">
                        Layout API
                        <i class="fa fa-fw fa-arrow-right opacity-50 ms-1"></i>
                      </a>
                    </div>
