    <div id="page-container" class="sidebar-o sidebar-light enable-page-overlay side-scroll page-header-fixed main-content-narrow">
      ...
      <nav id="sidebar" aria-label="Main Navigation">
        ...
        <div class="bg-header-dark">
          <div class="content-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
    <!-- Logo -->
    <a class="fw-semibold d-flex align-items-center text-decoration-none" href="{{ route('dashboard') }}">
        <img src="{{ url('assets/media/logo1.png') }}" 
...
<li class="nav-main-item">
    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
        ...
        <span class="nav-main-link-name">Service Status</span>
    </a>
    <ul class="nav-main-submenu">
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('service-statuses.create') }}">
                <span class="nav-main-link-name">Add New Status</span>
            </a>
        </li>
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('service-statuses.index') }}">
                <span class="nav-main-link-name">Status List</span>
            </a>
        </li>
    </ul>
</li>
    ...
    <ul class="nav-main-submenu">
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('tickets.create') }}">
                <span class="nav-main-link-name">Add New Ticket</span>
            </a>
        </li>
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('tickets.index') }}">
                <span class="nav-main-link-name">Tickets List</span>
            </a>
        </li>
    </ul>
</li>
...
<li class="nav-main-item">
    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
        ...
        <span class="nav-main-link-name">Manage Logs</span>
    </a>
    <ul class="nav-main-submenu">
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('logs.index') }}">
                <span class="nav-main-link-name">Logs List</span>
            </a>
        </li>
    </ul>
</li>
...
<li class="nav-main-item">
    <a class="nav-main-link" href="{{ route('spares.index') }}">
        <i class="nav-main-link-icon fa fa-cogs"></i>
        <span class="nav-main-link-name">Spares</span>
    </a>
</li>
@if($userRole === 'superadmin')
<li class="nav-main-item">
    <a class="nav-main-link" href="{{ route('category-mapping.index') }}">
        <i class="nav-main-link-icon fa fa-tags"></i>
        <span class="nav-main-link-name">Category Mapping</span>
    </a>
</li>
...
<li class="nav-main-item">
    <a class="nav-main-link" href="{{ route('procurements.index') }}">
        <i class="nav-main-link-icon fa fa-truck"></i>
        <span class="nav-main-link-name">Procurements</span>
    </a>
</li>
@endif
<!--<li class="nav-main-item">-->
<!--    <a class="nav-main-link" href="{{ route('tickets.serviceTickets') }}">-->
<!--        <i class="nav-main-link-icon fa fa-ticket-alt"></i>-->
<!--        <span class="nav-main-link-name">Service Tickets</span>-->
<!--    </a>-->
<!--</li>-->
 <li class="nav-main-item">
    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
    ...
    <ul class="nav-main-submenu">
        ...
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('tickets.serviceTicketsimport') }}">
                <span class="nav-main-link-name">Service Tickets Import</span>
            </a>
        </li>
        @endif
        <li class="nav-main-item">
            <a class="nav-main-link" href="{{ route('tickets.serviceTickets') }}">
                <span class="nav-main-link-name">Service Tickets List</span>
            </a>
        </li>
    </ul>
</li> 
          ...
          <div class="space-x-1">
            ...
            <div class="dropdown d-inline-block">
              <button type="button" class="btn btn-alt-secondary" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="d-none d-sm-inline-block"><?php $user = auth()->user();
   echo $userRole = $user->name ?? null;
    ?></span>
    ...
    <i class="far fa-fw fa-user me-1"></i> Change Password
</a>
